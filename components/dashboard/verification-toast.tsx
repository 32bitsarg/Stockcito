  ...
  return (
    <AnimatePresence>
      {toast && (
        ...
        >
          <div className={`flex items-start gap-3 p-4 rounded-lg shadow-lg border ${toast.type === 'success'
            ...
            <div className="flex-1 min-w-0">
              <p className={`font-medium ${toast.type === 'success' ? 'text-green-800 dark:text-green-200' : 'text-primary dark:text-primary-foreground'
                }`}>
                {toast.title}
              </p>
              <p className={`text-sm mt-0.5 ${toast.type === 'success' ? 'text-green-600 dark:text-green-300' : 'text-primary/80 dark:text-primary-foreground/80'
                }`}>
                {toast.description}
              </p>
            </div>
            <button
              ...
              className={`p-1 rounded hover:bg-black/5 dark:hover:bg-white/10 ${toast.type === 'success' ? 'text-green-500' : 'text-primary'
                }`}
            >
              <X className="h-4 w-4" />
            </button>
